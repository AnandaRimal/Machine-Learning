...
The L1 penalty creates sparsity: many coefficients become exactly zero, yielding a simpler, interpretable model.
...
### Caveats
- Lasso can be unstable when features are highly correlated; it may arbitrarily keep one and drop others.
- Standardize inputs before Lasso, as penalties depend on scale.
